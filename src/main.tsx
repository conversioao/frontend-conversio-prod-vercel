...
window.fetch = async (...args) => {
  ...
  try {
    ...
    // Return a fake response to avoid crashing components that expect a response object
    return new Response(JSON.stringify({ success: false, message: 'Erro de conexão com o servidor.' }), {
      status: 503,
