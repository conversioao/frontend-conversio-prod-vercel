...
const UgcVideoCard = ({ src, creator, title, isVideo = false }: { src: string, creator: string, title: string, isVideo?: boolean }) => {
  ...
  return (
    ...
    >
      ...
      {/* AO VIVO badge */}
      <div className="absolute top-4 left-4 bg-black/70 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-black text-white border border-white/15 flex items-center gap-2 shadow-lg z-30 tracking-widest uppercase">
      ...
      <div className="absolute bottom-6 left-5 right-5 text-white pointer-events-none z-20">
         <p className="font-bold text-xs flex items-center gap-1 drop-shadow-md">@{creator} <CheckCircle2 size={12} className="text-[#FFB800]" /></p>
         <div className="mt-2 bg-[#FFB800] px-2 py-0.5 rounded text-[9px] font-black text-black w-max flex items-center gap-1 shadow-xl uppercase tracking-widest italic">IA Criativo</div>
      </div>
...
export function LandingPage({ onEnter, onNavigate }: LandingPageProps) {
  ...
  return (
    <div ref={containerRef} className="min-h-screen w-full font-sans overflow-x-hidden relative selection:bg-[#FFB800]/30 selection:text-text-primary bg-[#050505] text-text-primary">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative max-w-5xl mx-auto h-full">
            {[
              ...
              <Reveal key={i} delay={i * 0.2}>
                <BentoCard className="text-center group flex flex-col items-center h-full justify-start min-h-[320px]">
                  ...
                  <p className="text-text-secondary text-sm relative z-20 flex-grow leading-relaxed">{step.desc}</p>
                </BentoCard>
              </Reveal>
            ))}
          </div>
      ...
      {/* 🚀 PRÓXIMA ATUALIZAÇÃO (WhatsApp CRM) */}
      <section className="py-24 relative z-20">
        <div className="container mx-auto px-6 max-w-6xl">
          <Reveal>
            <div className="relative overflow-hidden rounded-[2.5rem] p-[1px] bg-gradient-to-r from-[#FFB800]/50 via-accent/30 to-[#FFB800]/50 shadow-[0_0_50px_rgba(255,184,0,0.15)]">
              <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10 mix-blend-overlay"></div>
              <div className="relative bg-[#0A0A0A]/95 backdrop-blur-2xl rounded-[calc(2.5rem-1px)] p-8 md:p-14 flex flex-col md:flex-row items-center justify-between gap-10 border border-white/5 overflow-hidden">
                ...
                <div className="flex-1 relative z-10 text-center md:text-left">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#FFB800]/20 border border-[#FFB800]/30 text-[#FFB800] text-[10px] font-black uppercase tracking-widest mb-6">
                  ...
                  <h3 className="text-3xl md:text-5xl font-black text-white mb-4 tracking-tighter">Agentes de Vendas no <span className="text-[#25D366]">WhatsApp</span></h3>
                  <p className="text-text-secondary text-lg md:text-xl max-w-2xl leading-relaxed font-light">
                    A tua equipa de vendas vai ser automatizada. Um <strong>CRM integrado</strong>, <strong>Funil de Vendas Inteligente</strong> e agentes autónomos que respondem, qualificam e fecham clientes 24/7 de forma humanizada.
                  </p>
                </div>
                
                <div className="relative z-10 shrink-0">
                  <div className="w-32 h-32 md:w-40 md:h-40 rounded-3xl bg-gradient-to-br from-[#25D366]/20 to-[#FFB800]/20 border border-white/10 flex items-center justify-center shadow-[0_0_50px_rgba(37,211,102,0.15)] group relative overflow-hidden">
                    <div className="absolute inset-0 bg-white/5 group-hover:bg-white/10 transition-colors"></div>
                    <Bot className="w-16 h-16 md:w-20 md:h-20 text-[#FFB800] animate-pulse" strokeWidth={1.5} />
                    <div className="absolute -bottom-2 -right-2 w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg border-4 border-[#0A0A0A]">
                      <Target className="w-8 h-8 text-[#0A0A0A]" strokeWidth={2.5} />
                    </div>
                  </div>
                </div>
              </div>
