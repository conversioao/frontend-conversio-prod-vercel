                  ...
                  <div className="relative">
                    ...
                    {activeDropdown === 'model' && (
                      <div className="absolute top-full left-0 mt-2 w-56 bg-surface border border-border-subtle rounded-2xl shadow-xl overflow-hidden z-[100] py-1 animate-in fade-in slide-in-from-top-2 duration-200">
                        ...
                        {[
                          { id: 'V4', name: 'Music V4 Basic', credit_cost: 5 },
                          { id: 'V4_5', name: 'Music V4.5 Pro', credit_cost: 8 },
                          { id: 'V4_5PLUS', name: 'Music V4.5 Plus', credit_cost: 10 },
                          { id: 'V4_5ALL', name: 'Music V4.5 All', credit_cost: 12 },
                          { id: 'V5_5', name: 'Music V5.5 Elite', credit_cost: 15 },
