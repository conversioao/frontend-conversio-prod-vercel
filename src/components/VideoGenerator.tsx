...
const VIDEO_CORES = [
  ...
  { id: 'cinematic-vfx', name: 'Cinematic VFX 3D', agentTechnicalId: 'cinematic-vfx', icon: Zap, description: 'Montagem de produto 3D de alta gama e efeitos visuais cinematográficos.', credit_cost: 20 },
  { id: 'vibra-premium', name: 'Vibra Premium Luxo', agentTechnicalId: 'vibra-premium', icon: Sparkles, description: 'Estilo editorial de luxo, texturas macro e estética sofisticada.', credit_cost: 20 },
  { id: 'urban-style', name: 'Estilo Urbano', agentTechnicalId: 'urban-style', icon: MapPin, description: 'Anúncios dinâmicos em cenários de cidade moderna com moda edgy.', credit_cost: 15 },
  { id: 'minimalist-studio', name: 'Estúdio Minimalista', agentTechnicalId: 'minimalist-studio', icon: Package, description: 'Showcase de produto limpo e de alta gama com estética de estúdio minimalista.', credit_cost: 15 },
];
