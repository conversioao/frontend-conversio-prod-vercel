...
import { Search, Edit, ShieldAlert, Check, User, History, CreditCard, Layers, X, ExternalLink, Filter, Zap, Mail, Clock, CheckCircle, XCircle, MessageSquare, Video } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-text-primary tracking-tight flex items-center gap-3">
            CRM Clientes
            <span className="px-2 py-0.5 bg-emerald-500/10 text-emerald-500 text-[9px] font-black rounded-md border border-emerald-500/20 uppercase tracking-widest animate-pulse">Servidor v2026.05.22-MVP</span>
          </h1>
