...
export default function AdminWhatsAppLeads() {
  ...
  return (
    <div className="fixed inset-0 h-screen w-full flex flex-col bg-[#050A08] text-white font-sans selection:bg-[#FFB800]/30 overflow-hidden z-[50]">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            <h2 className="text-xl font-bold tracking-tight">
              Gestor de Leads <span className="text-[#FFB800] ml-1">v2.4.3 [MUSIC-CORE-FIX]</span>
            </h2>
          </div>
          ...
          >
            ...
            <div className="flex-1 flex gap-10 overflow-hidden">
               <div className="flex-1 flex flex-col gap-4">
                 <div className="bg-white/5 border border-[#FFB800]/20 p-4 rounded-2xl flex items-start gap-4 mb-2">
                   <Brain className="text-[#FFB800] shrink-0 mt-1" size={24} />
                   <div>
                     <h4 className="text-sm font-black text-white uppercase tracking-tight mb-1">Directrizes de Personalidade (pt-AO)</h4>
                     <p className="text-xs text-white/50 leading-relaxed">
                       O Alex é um humano. Evite formatos robóticos (listas, bullets). Use sempre o português de Angola (Kwanza, Mambo, Fixe, Telemóvel). O agente fará automaticamente a distinção entre Leads (oferecer 1000 créditos e tentar registo) e Utilizadores (tentar upsell e ajudar com histórico).
                     </p>
                   </div>
                 </div>
                 <textarea 
                    ...
                    className="flex-1 bg-black/20 border border-white/10 rounded-2xl p-8 text-sm font-medium text-white/80 focus:outline-none focus:border-[#FFB800]/40 transition-all resize-none custom-scrollbar leading-relaxed"
                    placeholder="Defina as diretrizes adicionais aqui..."
                 />
               </div>
               <div className="w-80 flex flex-col gap-6">
                   <div className="p-8 bg-white/[0.03] border border-white/5 rounded-2xl relative overflow-hidden group hover:border-[#FFB800]/30 transition-all">
                      <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity"><Zap size={80} /></div>
                      <h6 className="text-[10px] font-black text-[#FFB800] uppercase tracking-widest mb-2 relative z-10">Conexão API (Webhook)</h6>
                      <p className="text-[10px] text-white/40 mb-6 leading-relaxed relative z-10">Ativa a sincronização bidirecional em tempo real (envio e recepção). Clique apenas 1 vez.</p>
                      <button onClick={setupWebhook} disabled={isSavingConfig} className="w-full py-4 bg-white/5 border border-white/10 text-white/80 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-[#FFB800] hover:text-black hover:border-[#FFB800] transition-all disabled:opacity-50 relative z-10">
                        {isSavingConfig ? 'Sincronizando...' : 'Sincronizar Canal'}
                      </button>
                   </div>
                   
                   <div className="p-8 bg-white/[0.03] border border-white/5 rounded-2xl flex flex-col gap-4">
                     <h6 className="text-[10px] font-black text-white/60 uppercase tracking-widest border-b border-white/10 pb-3">Agendamento de Nutrição (Cron)</h6>
                     <div className="flex items-center justify-between">
                       <span className="text-[10px] font-bold text-white/40">Leads Frios (&gt;24h s/ resposta)</span>
                       <span className="px-2 py-1 bg-emerald-500/10 text-emerald-400 text-[8px] font-black rounded-md border border-emerald-500/20">ATIVO</span>
                     </div>
                     <div className="flex items-center justify-between">
                       <span className="text-[10px] font-bold text-white/40">Utilizadores VIP (Upsell)</span>
                       <span className="px-2 py-1 bg-emerald-500/10 text-emerald-400 text-[8px] font-black rounded-md border border-emerald-500/20">ATIVO</span>
                     </div>
                   </div>
               </div>
